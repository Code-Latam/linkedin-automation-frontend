...
export const featuresText = {
    ...
    items: [
        ...
        },
        {
            ...
            description: "Scale to thousands of simultaneous prospect conversations across multiple accounts while eliminating the cost of expanding your team or having any team at all. We provide the accounts if needed. Follow results on your dashboard",
